  ...
  return (
    <div className="agent-sessions">
      ...
      <div className="agent-sessions__list">
        {!workspaceId ? (
          <div className="agent-sessions__empty">Open a project to manage its sessions.</div>
          ...
          sessions.map((session) => (
            <div
              className={`agent-sessions__item${selectedIds.has(session.id) ? " is-selected" : ""}`}
              key={session.id}
            >
              <label className="agent-sessions__select">
                <input
                  ...
                  onChange={(event) =>
                    setSelectedIds((current) => toggleId(current, session.id, event.target.checked))
                  }
                />
              </label>
              <button
              ...
              >
                ...
                <span className="agent-sessions__time">{formatSessionTime(session.updatedAt)}</span>
              </button>
              <button
                type="button"
